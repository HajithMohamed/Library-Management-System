...
$maskedEmail = $_SESSION['force_pw_masked_email'] ?? 'your email';
$otpExpiry = $_SESSION['force_pw_otp_expiry'] ?? 0;
...
<style>
    ...
    .otp-verify-header {
        text-align: center;
        padding: 2.5rem 2rem;
        background: linear-gradient(135deg, rgba(234, 88, 12, 0.08), rgba(239, 68, 68, 0.08));
    ...
    .otp-verify-footer {
        ...
        background: linear-gradient(135deg, rgba(234, 88, 12, 0.03), rgba(239, 68, 68, 0.03));
    }
    ...
    @media (max-width: 640px) {
        .otp-verify-container { padding: 20px 16px; }
        .otp-verify-body { padding: 1.5rem; }
        .otp-input { font-size: 1.5rem; letter-spacing: 0.3em; }
    }
</style>
            ...
            <div class="col-lg-7">
                <div class="otp-verify-card">
                    ...
                    <div class="otp-verify-body">
                        ...
                        <form method="POST" action="<?= BASE_URL ?>verify-force-password-otp" id="otpForm">
                    ...
                    <div class="otp-verify-footer">
                        <a href="<?= BASE_URL ?>resend-force-password-otp" class="footer-link" id="resendLink">
