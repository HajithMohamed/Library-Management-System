...
<script>
// Autocomplete functionality - SAME AS UPDATED USERS VERSION
...
function displayAutocomplete(books) {
    ...
    autocompleteDropdown.innerHTML = books.slice(0, 8).map(book => {
        ...
        return `
            <div class="autocomplete-item" onclick="selectBook('<?= BASE_URL ?>faculty/book/${encodeURIComponent(book.isbn)}')">
                ${imageHtml}
