        ...
        <div class="book-card">
                ...
                <div class="book-image-wrapper">
                    <?php if (!empty($book['bookImage'])): ?>
                        ...
                        <img src="<?= BASE_URL . htmlspecialchars($imgSrc) ?>"
                            alt="<?= htmlspecialchars($book['bookName']) ?>" class="book-image"
                        ...
                        <div class="default-book-cover"
                            style="display: none; width: 100%; height: 100%; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); align-items: center; justify-content: center; flex-direction: column; gap: 1rem; padding: 2rem;">
                            <i class="fas fa-book" style="font-size: 5rem; color: white; opacity: 0.9;"></i>
                            <div
                                style="color: white; font-size: 1.2rem; font-weight: 700; text-align: center; opacity: 0.9;">
                                No Cover Available</div>
                        </div>
                    <?php else: ?>
                        <img src="<?= BASE_URL ?>assets/images/no-book-cover.jpg" alt="Default book cover"
                            class="book-image"
            ...
            <div class="book-details-section">
                    ...
                    <div class="availability-content">
                        ...
                        <div class="availability-text">
                            <?php if ($book['available'] > 0): ?>
                                <?= $book['available'] ?>     <?= $book['available'] == 1 ? 'copy' : 'copies' ?> ready to
                                reserve
                            <?php else: ?>
                                All <?= $book['totalCopies'] ?>     <?= $book['totalCopies'] == 1 ? 'copy is' : 'copies are' ?>
                                currently borrowed
                            <?php endif; ?>
                        </div>
                    </div>
                ...
                <div class="action-section">
                    <?php if ($book['available'] > 0): ?>
                        <form method="POST" action="<?= BASE_URL ?>user/reserve/<?= urlencode($book['isbn']) ?>"
                ...
                <?php if ($book['available'] == 0): ?>
                    <div class="waiting-info">
                        ...
                        <div class="waiting-info-text">
                            <strong>Join the waiting list</strong> to be notified when this book becomes available. You'll
                            receive an email notification as soon as a copy is returned.
                        </div>
                    </div>
                <?php endif; ?>
            </div>
