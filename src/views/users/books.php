                ...
                <div class="book-card-modern">
                    ...
                    <div class="book-content">
                        ...
                        <div class="action-buttons-group">
                            <a href="<?= BASE_URL ?>user/book?isbn=<?= urlencode($book['isbn'] ?? '') ?>" class="action-button-modern btn-view-details">
                                <i class="fas fa-eye"></i> Details
                            </a>
                            <?php if (isset($_SESSION['userId'])): ?>
                                <?php if (($book['available'] ?? 0) > 0): ?>
                                    <a href="<?= BASE_URL ?>user/reserve?isbn=<?= urlencode($book['isbn'] ?? '') ?>" class="action-button-modern btn-reserve">
                                        <i class="fas fa-bookmark"></i> Reserve
                                    </a>
                                <?php else: ?>
                                    <button class="action-button-modern btn-reserve" disabled style="opacity: 0.6; cursor: not-allowed;">
