    ...
    <div class="page-content">
      ...
      <div class="content-card">
        ...
        <div class="filters">
            ...
            <select id="userFilter" onchange="applyFilters()">
              ...
              <?php foreach ($users as $user): ?>
                <option value="<?= $user['userId'] ?>" <?= ($userId ?? '') === $user['userId'] ? 'selected' : '' ?>>
                  <?= htmlspecialchars($user['username'] ?? $user['emailId']) ?>
                </option>
              <?php endforeach; ?>
            </select>
          </div>
          <div class="filter-group">
            <label>Book</label>
            <select id="bookFilter" onchange="applyFilters()">
              <option value="">All Books</option>
              <?php foreach ($books as $book): ?>
                <option value="<?= $book['isbn'] ?>" <?= ($isbn ?? '') === $book['isbn'] ? 'selected' : '' ?>>
...
<div id="borrowModal" class="modal">
  <div class="modal-content">
    ...
    <form id="borrowForm" method="POST" action="<?= BASE_URL ?>admin/borrowed-books">
...
<script>
  function openAddModal() {
    ...
    document.getElementById('borrowForm').action = '<?= BASE_URL ?>admin/borrowed-books/add';
  ...
  function openEditModal(record) {
    ...
    document.getElementById('borrowForm').action = '<?= BASE_URL ?>admin/borrowed-books/update';
  ...
  function applyFilters() {
    ...
    const isbn = document.getElementById('bookFilter').value;

    let url = '<?= BASE_URL ?>admin/borrowed-books?';
    const params = [];

    if (status) params.push('status=' + status);
    if (userId) params.push('userId=' + userId);
    if (isbn) params.push('isbn=' + isbn);
