...
<div class="main-container">
  ...
  <div class="content-area">
    ...
    <div class="buttons">
      <button type="button" class="button search" id="Search books">SEARCH BOOKS</button>
      <button type="button" class="button issue" id="Borrow books">BORROW BOOKS</button>
      <button type="button" class="button return" id="Return books">RETURN BOOKS</button>
      <button type="button" class="button pay" id="Pay fines">PAY FINES</button>
    </div>
  </div>
...
//Search Books in the library button
document.getElementById('Search books').onclick=function(){
  window.location.href='SearchBooks.php';
}
//Borrow Books from the library button
document.getElementById('Borrow books').onclick=function(){
  window.location.href='BorrowBooks.php';
}
//Return Books to the library button
document.getElementById('Return books').onclick=function(){
  window.location.href='ReturnBooks.php';
}
//Pay Fine button
document.getElementById('Pay fines').onclick=function(){
  window.location.href='ShowFines.php';
}
</script>
